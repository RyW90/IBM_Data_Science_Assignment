...
spacex_launch_dash_csv = "https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBM-DS0321EN-SkillsNetwork/datasets/spacex_launch_dash.csv"
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df['class1'] = 1
        fig = px.pie(filtered_df, values='class1', 
        names='class', 
        title='Total Success Luanches for Site ' + entered_site)
        return fig
